...
const packed_LE = new Uint8Array([
	// Numbers
	0x7B, 0xD2, 0x04, 0x39, 0x30, 0x00, 0x00, 0x7B, 0xD2, 0x04, 0x39, 0x30,
	0x00, 0x00, 0x79, 0xE9, 0xF6, 0x42, 0x77, 0xBE, 0x9F, 0x1A, 0x2F, 0xDD,
	0x5E, 0x40,
	// Numbers
	0x7B, 0xD2, 0x04, 0x39, 0x30, 0x00, 0x00, 0x7B, 0xD2, 0x04, 0x39, 0x30,
	0x00, 0x00, 0x79, 0xE9, 0xF6, 0x42, 0x77, 0xBE, 0x9F, 0x1A, 0x2F, 0xDD,
...
const packed_BE = new Uint8Array([
	// Numbers
	0x7B, 0x04, 0xD2, 0x00, 0x00, 0x30, 0x39, 0x7B, 0x04, 0xD2, 0x00, 0x00,
	0x30, 0x39, 0x42, 0xF6, 0xE9, 0x79, 0x40, 0x5E, 0xDD, 0x2F, 0x1A, 0x9F,
	0xBE, 0x77,
	// Numbers
	0x7B, 0x04, 0xD2, 0x00, 0x00, 0x30, 0x39, 0x7B, 0x04, 0xD2, 0x00, 0x00,
	0x30, 0x39, 0x42, 0xF6, 0xE9, 0x79, 0x40, 0x5E, 0xDD, 0x2F, 0x1A, 0x9F,
...
describe('Mode base tests', () => {
	...
	it('Length mode', () => {
		...
		assert.strictEqual(length, 80);
		assert.doesNotThrow(() => {length = struct.length(input, 'BE')});
		assert.strictEqual(length, 80);
	});

	it('Pack mode', () => {
		const packed = new Uint8Array(80);
